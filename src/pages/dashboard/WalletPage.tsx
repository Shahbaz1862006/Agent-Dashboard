...
export function WalletPage() {
    ...
    const connectCoinductorWallet = () => {
        // Logic for connecting Coinductor wallet (mock implementation)
        setWalletAddress("Coinductor Wallet Address");
        console.log("Coinductor wallet connected!");
    };
  ...
  return (
    ...
    {/* Adding the new source wallet address input */}
    <Input
    ...
    />
    {/* Adding the button to connect Coinductor wallet */}
    <Button size="sm" variant="secondary" onClick={connectCoinductorWallet}>Connect Coinductor Wallet</Button>
                Deposit USDT
              </Button>
            </div>
          </CardHeader>
        ...
        footer={
          <div className="flex gap-2">
            ...
            <Button
              variant="primary"
              onClick={() => {
                toast.push({ title: "Deposit initiated", message: "Waiting for confirmations.", tone: "info" });
